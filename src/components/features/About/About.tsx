      ...
      <div className={`container ${styles.aboutContainer}`}>
        ...
        <div className={styles.aboutBox}>
          ...
          <p>
            ...
            Tenho experiência com React, JavaScript, TypeScript, Python e
            Express, além de ORMs para bancos de dados. Também tenho noções
            sobre Docker e orquestração de containeres com Kubernetes. Possuo
            boas habilidades em comunicação interpessoal, trabalho em equipe e{" "}
            <span className="highlight">
